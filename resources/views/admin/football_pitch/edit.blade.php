      ...
      <div class="col-12">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Mã loại sân" name="ma_loai_san" value="{{ $footballPitch->ma_loai_san }}">
          </div>
          <div class="form-group">
            <label for="pwd">Tên:</label>
            <input type="text" class="form-control" placeholder="Tên" name="ten" value="{{ $footballPitch->ten }}">
          </div>
          <div class="form-group">
            <label for="pwd">Mô tả:</label><br>
            <textarea style="border: 1px solid rgba(0,0,0,.15); padding-left: 10px" name="mo_ta" placeholder="Mô tả" cols="50" rows="5">{{ $footballPitch->mo_ta }}</textarea>
          </div>
