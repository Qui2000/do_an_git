  ...
  <div class="container-fluid">
    ...
    <div class="row page-titles">
      <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">Quản lý sân bóng / Thêm sân bóng</h3>
      </div>
    </div>
    @if(session('success'))
      ...
      <div class="col-12">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea style="border: 1px solid rgba(0,0,0,.15); padding-left: 10px" name="mo_ta" placeholder="Mô tả" cols="50" rows="5"></textarea>
          </div>
