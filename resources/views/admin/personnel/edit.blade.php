      ...
      <div class="col-12">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Tên khách hàng" name="ten" value="{{ $personnel->ten }}">
          </div>
          <div class="form-group">
            <label for="email">Ngày sinh:</label>
            <input type="date" class="form-control" placeholder="Ngày sinh" name="ngay_sinh" value="{{ $personnel->ngay_sinh }}">
          </div>
          <div class="form-group">
            <label for="pwd">Địa chỉ:</label>
            <input type="text" class="form-control" placeholder="Địa chỉ" name="dia_chi" value="{{ $personnel->dia_chi }}">
          </div>
          <div class="form-group">
            <label for="pwd">Số điện thoại:</label>
            <input type="text" class="form-control" placeholder="Số điện thoại" name="sdt" value="{{ $personnel->sdt }}">
          </div>
          <div class="form-group">
            <label for="pwd">Giới tính:</label>
            <input type="text" class="form-control" placeholder="Giới tính" name="gioi_tinh" value="{{ $personnel->gioi_tinh }}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="ma_quyen" id="">
              @foreach($permissions as $key => $permission)
                <option value="{{ $permission->ma_quyen }}" {{ $permission->ma_quyen == $personnel->ma_quyen ? 'selected' : '' }}>  
                  {{ $permission->ten}}
                </option>
              @endforeach
            </select>
